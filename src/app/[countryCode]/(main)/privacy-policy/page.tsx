  ...
  return (
    <div className="max-w-7xl mx-auto space-y-4 py-12 px-4 text-gray-800/60">
      ...
      <div className="space-y-4">
        ...
        <p className="text-gray-800/60">
          When you use our Site, we collect certain details to enhance your
        ...
        <ul className="list-disc list-inside text-gray-800/60">
          ...
          <li>Time zone</li>
          <li>Cookie data</li>
          <li>Pages viewed and products interacted with</li>
        ...
        <p>
          ...
          <span className="text-gray-800/60">
            To ensure our Site functions effectively and to gain insights for
        ...
        <p>
          ...
          <span className="text-gray-800/60">
            Automatically collected through cookies, log files, and similar
            technologies.
          </span>
        </p>
        <p>
          ...
          <span className="text-gray-800/60">
            Shared with service providers, including Razorpay and Shiprocket.
          </span>
        </p>
        ...
        <p>
          ...
          <span className="text-gray-800/60">
            To fulfill orders, process payments, coordinate shipping, send order
            confirmations, and communicate with you about your purchase.
          </span>
        </p>
        <p>
          <span className="font-semibold text-md text-gray-800/80">
          ...
          <span className="text-gray-800/60">
            Directly collected from you during the checkout process.
          </span>
        </p>
        <p>
          <span className="font-semibold text-md text-gray-800/80">
          ...
          <span className="text-gray-800/60">
            Shared with Razorpay for payment processing and Shiprocket for
            shipping logistics.
          </span>
        </p>
        <h2 className="font-semibold text-md text-gray-800/80">
        ...
        <p>
          ...
          <span className="text-gray-800/60">
            To resolve inquiries and provide customer assistance.
          </span>
        </p>
        <p>
          <span className="font-semibold text-md text-gray-800/80">
          ...
          <ul className="list-disc list-inside py-2">
            <li>
              ...
              <span className="text-gray-800/60">
                ...
                practices or to opt out, you can visit Google&apos;s privacy
                settings.
              </span>
            </li>
            <li>
